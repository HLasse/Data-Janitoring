...
In the model i chose to include Visit, MOT_MLU and verbalIQ as predictors. All of them shows significant effects, and are not too correlated with each other. If the model were to include pretty much any of the other variables, problems of colinearity would occur. The model achieved a R²m  of 0.56
